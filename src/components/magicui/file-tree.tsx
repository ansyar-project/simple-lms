...
>(({ element, value, isSelectable = true, isSelect, children, ...props }) =>
  // removed ref
  {
    const {
      direction,
    ...
    return (
      ...
      >
        <AccordionPrimitive.Trigger
          className={cn(`flex items-center gap-1 rounded-md text-sm`, {
...
>(({ value, isSelectable = true, isSelect, fileIcon, children, ...props }) =>
  // removed ref
  {
