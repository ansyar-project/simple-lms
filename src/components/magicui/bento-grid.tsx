...
const BentoCard = ({
  ...
  >
    <div>{background}</div>
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10 flex-1">
      ...
      <p className="max-w-lg text-neutral-700 dark:text-neutral-300 flex-1">
        {description}
      </p>
    </div>
